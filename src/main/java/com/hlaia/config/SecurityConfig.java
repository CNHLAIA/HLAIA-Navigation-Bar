    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Favicon 代理接口（公开，因为前端 <img> 标签无法携带 JWT Token）
                .requestMatchers("/api/favicon/**").permitAll()
            ...
            // 配置未认证请求的处理方式
            // ============================================================
            // 默认情况下，Spring Security 对未认证请求返回 403 Forbidden
            // 但前端是根据 HTTP 401 来触发 Token 刷新的
            // 所以需要自定义 AuthenticationEntryPoint，让它返回 401 而非 403
